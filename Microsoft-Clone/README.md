...
This project is a clone of the Microsoft website interface, built using HTML, Tailwind CSS, and Vite. The project aims to replicate the design and functionality ofthe Microsoft website, providing a modern and optimized user experience.
